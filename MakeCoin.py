...
class Two_Pound(Coin):
    def __init__ (self):
        ...
        super().__init__(**data)#super keyword use with kwargs
...
for coin in coins:
    ...
    string="{}.Color:{},Value:{},Daimeter(mm):{},Thickness(mm):{},number of edges:{},mass(g):{}".format(*arguments)
    print(string)
